...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://marginalrevolution.com/marginalrevolution/category/books").then(function(response) {
   let C$ = cheerio.load(response.data)

    C$('h2 a').each(function(i , link) {
        let result = {};
...
app.get("/Bookrecs/:id", function(req, res) {
  // Using the id passed in the id parameter, prepare a query that finds the matching one in our db...
  db.Bookrecs.findOne({ _id: req.params.id })
...
app.post("/Bookrecs/:id", function(req, res) {
